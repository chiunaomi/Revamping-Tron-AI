...
print(640-tron_font.size("\u25b2")[0])

screen = pygame.display.set_mode((640,480))
running = True
down_loc = [(300,200),(0,0)]

while running:
    side_length = (40,40)
    for i in range(2):
        rectangle = pygame.Rect(down_loc[i],side_length)
        rectangle1 = pygame.Rect((down_loc[i][0]-(side_length[0]+10),down_loc[i][1]),side_length)
